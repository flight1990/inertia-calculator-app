...
<template>
    <Link href="/admin" class="flex items-center gap-2 select-none">
        <svg class="h-8 lg:h-10" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <h3 class="text-lg lg:text-2xl font-medium text-gray-700">
            Calcutor
        </h3>
    </Link>
</template>
