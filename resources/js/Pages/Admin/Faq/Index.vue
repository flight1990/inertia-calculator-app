                ...
                <div class="inline-flex gap-2">
                    ...
                    <RDialog title="Внимание!" :width="420">
                        ...
                        <template v-slot:body>
                            Вы действительно хотите удалить <strong>"{{ item.question }}"</strong>?
                        </template>
                        <template v-slot:footer>
                            <button @click="deleteFaq(item.id)" type="button" class="py-2 px-3 inline-flex text-sm font-medium rounded-lg border border-rose-200 bg-rose-100 text-rose-800 shadow-sm hover:bg-rose-200 disabled:opacity-50 disabled:pointer-events-none">
                                Удалить
                            </button> 
                        </template>
                    </RDialog>
