                ...
                <div class="inline-flex gap-2">
                    ...
                    <RDialog title="Внимание!" :width="420">
                        ...
                        <template v-slot:footer>
                            <button @click="deleteCategory(item.id)" type="button" class="py-2 px-3 inline-flex text-sm font-medium rounded-lg border border-rose-200 bg-rose-100 text-rose-800 shadow-sm hover:bg-rose-200 disabled:opacity-50 disabled:pointer-events-none">
                                Удалить
                            </button> 
                        </template>
                    </RDialog>
