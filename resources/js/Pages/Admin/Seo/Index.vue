        ...
        >
            ...
            <template v-slot:item.actions="{item}">
                <div class="inline-flex gap-2">
                    ...
                    <button @click="deleteSeo(item.id)" type="button" class="py-1.5 px-1.5 inline-flex text-sm font-medium rounded-lg border border-rose-200 bg-rose-100 text-rose-800 shadow-sm hover:bg-rose-200 disabled:opacity-50 disabled:pointer-events-none">
